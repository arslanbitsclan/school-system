        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <!-- inquiry details -->
                    <li class="nav-parent <?php if ($main_menu == 'inquiry') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="far fa-chart-bar"></i><span><?=translate('inquiry')?></span>
                        </a>
                        <ul class="nav nav-children">
                        <li class="<?php if ($sub_page == 'inquiry/add') echo 'nav-active';?>">
                                <a href="<?=base_url('inquiry/add')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('add_inquiry')?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'inquiry/view') echo 'nav-active';?>">
                                <a href="<?=base_url('inquiry/view')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('inquiry_list')?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
