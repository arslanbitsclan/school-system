...
$CLIENT_ID = $json['web']['780761034559-5a69jrkteo36b85t6bn4ijr0n404t2te.apps.googleusercontent.com'];
$CLIENT_SECRET = $json['web']['t25qxcALXV_SnzqUKqwUiDJ_'];
$REDIRECT_URI = $json['web']['https://arslan.blogbaaz.com/googledrivesdk/'][0];
